...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 192 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 189 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 190 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 188 -- OnAbilityStart
MODIFIER_EVENT_ON_ASSIST = 242 -- OnAssist
MODIFIER_EVENT_ON_ATTACK = 181 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 202 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 184 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 256 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 183 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 245 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 182 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 179 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 253 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 180 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 263 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 191 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 216 -- OnBuildingKilled
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 200 -- OnDamageCalculated
MODIFIER_EVENT_ON_DEATH = 203 -- OnDeath
MODIFIER_EVENT_ON_DEATH_COMPLETED = 204 -- OnDeathCompleted
MODIFIER_EVENT_ON_DEATH_PREVENTED = 196 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 240 -- OnDominated
MODIFIER_EVENT_ON_FORCE_PROC_MAGIC_STICK = 285 -- OnForceProcMagicStick
MODIFIER_EVENT_ON_HEALTH_GAINED = 211 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 215 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 214 -- OnHeroKilled
MODIFIER_EVENT_ON_KILL = 241 -- OnKill
MODIFIER_EVENT_ON_MAGIC_DAMAGE_CALCULATED = 201 -- OnMagicDamageCalculated
MODIFIER_EVENT_ON_MANA_GAINED = 212 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 217 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 218 -- OnModifierAdded
MODIFIER_EVENT_ON_ORB_EFFECT = 198 -- Unused
MODIFIER_EVENT_ON_ORDER = 186 -- OnOrder
MODIFIER_EVENT_ON_PREDEBUFF_APPLIED = 264 -- OnPreDebuffApplied
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 199 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 193 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 185 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 254 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 194 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 205 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 210 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 178 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_HEALTH = 207 -- OnSpentHealth
MODIFIER_EVENT_ON_SPENT_MANA = 206 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 197 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 195 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 213 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TELEPORTED = 209 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 208 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 187 -- OnUnitMoved
MODIFIER_EVENT_SPELL_APPLIED_SUCCESSFULLY = 273 -- OnSpellAppliedSuccessfully
MODIFIER_FUNCTION_INVALID = 65535
MODIFIER_FUNCTION_LAST = 286
MODIFIER_PROPERTY_ABILITY_LAYOUT = 239 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 154 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 153 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 155 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 143 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 165 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 177 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 166 -- GetAllowEtherealAttack
MODIFIER_PROPERTY_AOE_BONUS_PERCENTAGE = 282 -- GetModifierAoEBonusPercentage
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 262 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 259 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 125 -- GetModifierPercentageAttackAnimTime
...
MODIFIER_PROPERTY_AVOID_DAMAGE_AFTER_REDUCTIONS = 274 -- GetModifierAvoidDamageAfterReductions
...
MODIFIER_PROPERTY_BECOME_UNIVERSAL = 284 -- GetModifierBecomeUniversal
...
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 147 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 148 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 149 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 258 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 169 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 170 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 247 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 124 -- GetModifierPercentageCasttime
...
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 236 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 122 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 123 -- GetModifierPercentageCooldownOngoing
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 265 -- GetModifierPercentageCooldownStacking
...
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_MULTIPLICATIVE = 279 -- GetModifierDamageOutgoing_PercentageMultiplicative
MODIFIER_PROPERTY_DEATHGOLDCOST = 130 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 145 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 164 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 234 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 172 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 251 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 63 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 131 -- GetModifierPercentageExpRateBoost
...
MODIFIER_PROPERTY_FAIL_ATTACK = 275 -- GetModifierPropetyFailAttack
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 30 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 150 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 151 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 233 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_GOLD_RATE_BOOST = 132 -- GetModifierPercentageGoldRateBoost
MODIFIER_PROPERTY_HEALTHBAR_PIPS = 271 -- GetModifierHealthBarPips
MODIFIER_PROPERTY_HEALTHCOST_PERCENTAGE = 128 -- GetModifierPercentageHealthcost
MODIFIER_PROPERTY_HEALTHCOST_PERCENTAGE_STACKING = 129 -- GetModifierPercentageHealthcostStacking
...
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 235 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 246 -- GetModifierIgnoreCooldown
...
MODIFIER_PROPERTY_ILLUSION_LABEL = 157 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT = 272 -- GetModifierIncomingDamageConstant
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST = 278 -- MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST
...
MODIFIER_PROPERTY_IS_ILLUSION = 156 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 225 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 226 -- GetModifierShard
MODIFIER_PROPERTY_KNOCKBACK_AMPLIFICATION_PERCENTAGE = 270 -- GetModifierKnockbackAmplification_Percentage
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 52 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 230 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 135 -- GetModifierMagical_ConstantBlock
...
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 126 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 127 -- GetModifierPercentageManacostStacking
...
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 174 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_HEALTH = 152 -- GetMinHealth
MODIFIER_PROPERTY_MISS_PERCENTAGE = 70 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MODEL_CHANGE = 220 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 221 -- GetModifierModelScale
MODIFIER_PROPERTY_MODEL_SCALE_ANIMATE_TIME = 222 -- GetModifierModelScaleAnimateTime
MODIFIER_PROPERTY_MODEL_SCALE_CONSTANT = 224 -- GetModifierModelScaleConstant
MODIFIER_PROPERTY_MODEL_SCALE_USE_IN_OUT_EASE = 223 -- GetModifierModelScaleUseInOutEase
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 260 -- GetModifierMoveSpeedReductionPercentage
...
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 237 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 238 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 140 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 142 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 141 -- GetOverrideAnimationWeight
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 11 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 167 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 15 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICALDAMAGEOUTGOING_PERCENTAGE = 269 -- GetModifierPhysicalDamageOutgoing_Percentage
...
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 136 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 137 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 133 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 176 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 134 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PREREDUCE_INCOMING_DAMAGE_MULT = 276 -- GetModifierPrereduceIncomingDamage_Mult
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 244 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 12 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 175 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_SPEED = 283 -- GetModifierProjectileSpeed
...
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 231 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 227 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_RAT_PACK = 268 -- GetModifierIsRatPack
MODIFIER_PROPERTY_REFLECT_SPELL = 144 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 117 -- ReincarnateTime
MODIFIER_PROPERTY_REINCARNATION_SUPPRESS_FX = 118 -- ReincarnateSuppressFX
MODIFIER_PROPERTY_RESPAWNTIME = 119 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 120 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 121 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SLOW_RESISTANCE = 281 -- GetModifierSlowResistance
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 232 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_SPELL_REDIRECT_TARGET = 266 -- GetModifierSpellRedirectTarget
...
MODIFIER_PROPERTY_STRONG_ILLUSION = 158 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 159 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 160 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 257 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_FULLSCREEN_DEATH_FX = 277 -- GetModifierSuppressFullscreenDeathFX
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 255 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 243 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TICK_GOLD_MULTIPLIER = 280 -- GetModifierTickGold_Multiplier
MODIFIER_PROPERTY_TOOLTIP = 219 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 252 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 44 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 139 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 138 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 228 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 229 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 173 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_CONSTANT = 267 -- GetModifierTurnRateConstant
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 163 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 162 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 171 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 168 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 248 -- GetVisualZDelta
MODIFIER_PROPERTY_VISUAL_Z_SPEED_BASE_OVERRIDE = 249 -- GetVisualZSpeedBaseOverride
MODIFIER_PROPERTY_XP_DURING_DEATH = 161 -- GetModifierXPDuringDeath
...
---[[ CDOTAGameRules:AddHeroIDToBlacklist  Add the hero ID to the hero blacklist if it is not already present ]]
-- @return void
-- @param int_1 int
function CDOTAGameRules:AddHeroIDToBlacklist( int_1 ) end

---[[ CDOTAGameRules:AddHeroIDToWhitelist  Add the hero ID to the hero whitelist if it is not already present ]]
-- @return void
-- @param int_1 int
function CDOTAGameRules:AddHeroIDToWhitelist( int_1 ) end

---[[ CDOTAGameRules:AddHeroToBlacklist  Add the hero to the hero blacklist if it is not already present ]]
-- @return void
-- @param string_1 string
function CDOTAGameRules:AddHeroToBlacklist( string_1 ) end

---[[ CDOTAGameRules:AddHeroToPlayerAvailability  Adds hero of given ID to available heroes of player of given ID ]]
-- @return void
-- @param int_1 int
-- @param int_2 int
function CDOTAGameRules:AddHeroToPlayerAvailability( int_1, int_2 ) end

---[[ CDOTAGameRules:AddHeroToWhitelist  Add the hero to the hero whitelist if it is not already present ]]
-- @return void
-- @param string_1 string
...
---[[ CDOTAGameRules:ClearHeroBlacklist  Clears the hero blacklist ]]
-- @return void
function CDOTAGameRules:ClearHeroBlacklist(  ) end

---[[ CDOTAGameRules:ClearHeroWhitelist  Clears the hero whitelist ]]
-- @return void
function CDOTAGameRules:ClearHeroWhitelist(  ) end

---[[ CDOTAGameRules:ClearPlayerHeroAvailability  Clears available heroes of player of given ID ]]
-- @return void
-- @param int_1 int
function CDOTAGameRules:ClearPlayerHeroAvailability( int_1 ) end

---[[ CDOTAGameRules:ClearRiverPaint  Clears the current river paint ]]
-- @return void
...
-- @param handle_4 handle
-- @param unsigned_5 unsigned
function CDOTAGameRules:ExecuteTeamPing( int_1, float_2, float_3, handle_4, unsigned_5 ) end
...
---[[ CDOTAGameRules:IsSuggestAbilitiesEnabled  Returns whether Dota Plus ability suggestions are enabled or disabled ]]
-- @return bool
function CDOTAGameRules:IsSuggestAbilitiesEnabled(  ) end

---[[ CDOTAGameRules:IsSuggestItemsEnabled  Returns whether Dota Plus item suggestions are enabled or disabled ]]
-- @return bool
...
---[[ CDOTAGameRules:RemoveHeroFromBlacklist  Remove the hero from the hero blacklist if present ]]
-- @return void
-- @param string_1 string
function CDOTAGameRules:RemoveHeroFromBlacklist( string_1 ) end

---[[ CDOTAGameRules:RemoveHeroFromWhitelist  Remove the hero from the hero whitelist if present ]]
-- @return void
-- @param string_1 string
function CDOTAGameRules:RemoveHeroFromWhitelist( string_1 ) end

---[[ CDOTAGameRules:RemoveHeroIDFromBlacklist  Remove the hero ID from the hero blacklist if present ]]
-- @return void
-- @param int_1 int
function CDOTAGameRules:RemoveHeroIDFromBlacklist( int_1 ) end

---[[ CDOTAGameRules:RemoveHeroIDFromWhitelist  Remove the hero ID from the hero whitelist if present ]]
-- @return void
-- @param int_1 int
...
---[[ CDOTAGameRules:ResetPlayer  Resets the player of a given ID. ]]
-- @return void
-- @param int_1 int
function CDOTAGameRules:ResetPlayer( int_1 ) end
...
---[[ CDOTAGameRules:SetEnableAlternateHeroGrids  Allow alternate hero grids to be used (DOTA+, etc).  True by default. ]]
-- @return void
-- @param bool_1 bool
...
---[[ CDOTAGameRules:SetHideBlacklistedHeroes  Should blacklisted heroes be hidden, or just dimmed, in hero picking? ]]
-- @return void
-- @param bool_1 bool
...
---[[ CDOTAGameRules:SetNeutralInitialSpawnOffset  Sets the extra offset to initial neutral creep spawn delay ]]
-- @return void
-- @param float_1 float
function CDOTAGameRules:SetNeutralInitialSpawnOffset( float_1 ) end
...
---[[ CDOTAGameRules:SetPostGameColumns  Set columns to show in post game ]]
-- @return bool
-- @param handle_1 handle
function CDOTAGameRules:SetPostGameColumns( handle_1 ) end

---[[ CDOTAGameRules:SetPostGameLayout  Configure post game to be single or double column layout ]]
-- @return void
-- @param int_1 int
function CDOTAGameRules:SetPostGameLayout( int_1 ) end

---[[ CDOTAGameRules:SetPostGameTeamScores  Set score value for each team. First element is for DOTA_TEAM_GOODGUYS. ]]
-- @return bool
-- @param handle_1 handle
function CDOTAGameRules:SetPostGameTeamScores( handle_1 ) end
...
---[[ CDOTAGameRules:SetRiverPaint  Paints the river for a duration ]]
-- @return void
-- @param int_1 int
-- @param float_2 float
...
---[[ CDOTAGameRules:SetSuggestAbilitiesEnabled  Sets Dota Plus ability suggestions enabled or disabled ]]
-- @return void
-- @param bool_1 bool
function CDOTAGameRules:SetSuggestAbilitiesEnabled( bool_1 ) end

---[[ CDOTAGameRules:SetSuggestItemsEnabled  Sets Dota Plus ability item enabled or disabled ]]
-- @return void
-- @param bool_1 bool
function CDOTAGameRules:SetSuggestItemsEnabled( bool_1 ) end
...
---[[ CDOTA_AghsFort_Ability_ArcWardenBoss_TempestDouble:SetNumDoubles  Sets the number of doubles to spawn. ]]
-- @return void
-- @param nDoubles int
function CDOTA_AghsFort_Ability_ArcWardenBoss_TempestDouble:SetNumDoubles( nDoubles ) end
