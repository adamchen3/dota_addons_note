...
-- @param bool_5 bool
-- @param handle_6 handle
function DebugCreateHeroWithVariant( handle_1, string_2, int_3, int_4, bool_5, handle_6 ) end
...
function DropNeutralItemAtPositionForHeroWithOffset( string_1, Vector_2, handle_3, int_4, bool_5, Vector_6 ) end
...
-- @param handle_1 handle
-- @param Vector_2 Vector
function GetClearSpaceForUnit( handle_1, Vector_2 ) end
...
---[[ GetDedicatedServerKeyV3  ( version ) ]]
-- @return string
-- @param string_1 string
function GetDedicatedServerKeyV3( string_1 ) end
...
-- @param handle_2 handle
-- @param int_3 int
function RecordNeutralItemEarned( handle_1, handle_2, int_3 ) end
...
-- @param float_4 float
-- @param float_5 float
function Script_RemapValClamped( float_1, float_2, float_3, float_4, float_5 ) end
...
---[[ ShowCustomHeaderMessage  ( const char *pszMessage, PlayerID_t nPlayerID, int nValue, float flTime ) - Supports localized strings - %s1 = PlayerName, %s2 = Value, %s3 = TeamName ]]
-- @return void
-- @param string_1 string
-- @param int_2 int
-- @param int_3 int
...
---[[ SpawnMangoTree  Spawn a mango tree ( vPos, nTeam, flDuration, flMangoInterval, nInitialMangoes ) ]]
-- @return handle
-- @param Vector_1 Vector
-- @param int_2 int
-- @param float_3 float
...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 194 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 191 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 192 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 190 -- OnAbilityStart
MODIFIER_EVENT_ON_ASSIST = 246 -- OnAssist
MODIFIER_EVENT_ON_ATTACK = 183 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 204 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 186 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 260 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 185 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 249 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 184 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 181 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 257 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 182 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 267 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 193 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 218 -- OnBuildingKilled
MODIFIER_EVENT_ON_CLEAVE_ATTACK_LANDED = 333 -- OnCleaveAttackLanded
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 202 -- OnDamageCalculated
MODIFIER_EVENT_ON_DAMAGE_HPLOSS = 295 -- OnDamageHPLoss
MODIFIER_EVENT_ON_DAY_STARTED = 321 -- OnDayStarted
MODIFIER_EVENT_ON_DEATH = 205 -- OnDeath
MODIFIER_EVENT_ON_DEATH_COMPLETED = 206 -- OnDeathCompleted
MODIFIER_EVENT_ON_DEATH_PREVENTED = 198 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 244 -- OnDominated
MODIFIER_EVENT_ON_FORCE_PROC_MAGIC_STICK = 294 -- OnForceProcMagicStick
MODIFIER_EVENT_ON_HEALTH_GAINED = 213 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 217 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_BEGIN_DYING = 315 -- OnHeroBeginDying
MODIFIER_EVENT_ON_HERO_KILLED = 216 -- OnHeroKilled
MODIFIER_EVENT_ON_KILL = 245 -- OnKill
MODIFIER_EVENT_ON_MAGIC_DAMAGE_CALCULATED = 203 -- OnMagicDamageCalculated
MODIFIER_EVENT_ON_MANA_GAINED = 214 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 219 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 220 -- OnModifierAdded
MODIFIER_EVENT_ON_MODIFIER_REMOVED = 221 -- OnModifierRemoved
MODIFIER_EVENT_ON_MUTE_DAMAGE_ABILITIES = 304 -- OnMuteDamageAbilities
MODIFIER_EVENT_ON_ORB_EFFECT = 200 -- Unused
MODIFIER_EVENT_ON_ORDER = 188 -- OnOrder
MODIFIER_EVENT_ON_PREDEBUFF_APPLIED = 268 -- OnPreDebuffApplied
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 201 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 195 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 187 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 258 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 196 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 207 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 212 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 180 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_HEALTH = 209 -- OnSpentHealth
MODIFIER_EVENT_ON_SPENT_MANA = 208 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 199 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 197 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 215 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TAKEDAMAGE_POST_UNAVOIDABLE_BLOCK = 303 -- OnTakeDamagePostUnavoidableBlock
MODIFIER_EVENT_ON_TELEPORTED = 211 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 210 -- OnTeleporting
MODIFIER_EVENT_ON_TREE_CUT_DOWN = 332 -- OnTreeCutDown
MODIFIER_EVENT_ON_UNIT_MOVED = 189 -- OnUnitMoved
MODIFIER_EVENT_SPELL_APPLIED_SUCCESSFULLY = 277 -- OnSpellAppliedSuccessfully
MODIFIER_FUNCTION_INVALID = 65535
MODIFIER_FUNCTION_LAST = 335
MODIFIER_PROPERTY_ABILITY_LAYOUT = 243 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABILITY_POINTS = 306 -- GetModifierAbilityPoints
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 156 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 155 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 157 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 144 -- GetAbsorbSpell
MODIFIER_PROPERTY_ADDITIONAL_NEUTRAL_ITEM_DROPS = 328 -- GetModifierAdditionalNutralItemDrops
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 167 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 179 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 168 -- GetAllowEtherealAttack
MODIFIER_PROPERTY_AOE_BONUS_CONSTANT = 301 -- GetModifierAoEBonusConstant
MODIFIER_PROPERTY_AOE_BONUS_CONSTANT_STACKING = 302 -- GetModifierAoEBonusConstantStacking
MODIFIER_PROPERTY_AOE_BONUS_PERCENTAGE = 287 -- GetModifierAoEBonusPercentage
MODIFIER_PROPERTY_ATTACKSPEED_ABSOLUTE_MAX = 313 -- GetModifierAttackSpeedAbsoluteMax
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 266 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 263 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 126 -- GetModifierPercentageAttackAnimTime
MODIFIER_PROPERTY_ATTACK_HEIGHT_BONUS = 325 -- GetModifierAttackHeightBonus
MODIFIER_PROPERTY_ATTACK_POINT_CONSTANT = 39 -- GetModifierAttackPointConstant
MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 110 -- GetModifierAttackRangeOverride
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 111 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 113 -- GetModifierAttackRangeBonusPercentage
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 112 -- GetModifierAttackRangeBonusUnique
MODIFIER_PROPERTY_ATTACK_WHILE_MOVING_TARGET = 265
MODIFIER_PROPERTY_AVOID_DAMAGE = 68 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_DAMAGE_AFTER_REDUCTIONS = 278 -- GetModifierAvoidDamageAfterReductions
...
MODIFIER_PROPERTY_BASE_ARMOR_PER_AGI_BONUS_PERCENTAGE = 318 -- GetModifierBonusLotusHeal
...
MODIFIER_PROPERTY_BASE_HP_REGEN_PER_STR_BONUS_PERCENTAGE = 317 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BASE_MANA_REGEN = 85 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BASE_MP_REGEN_PER_INT_BONUS_PERCENTAGE = 319 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BASE_MRES_PER_INT_BONUS_PERCENTAGE = 320 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BECOME_AGILITY = 291 -- GetModifierBecomeAgility
MODIFIER_PROPERTY_BECOME_INTELLIGENCE = 292 -- GetModifierBecomeIntelligence
MODIFIER_PROPERTY_BECOME_STRENGTH = 290 -- GetModifierBecomeStrength
MODIFIER_PROPERTY_BECOME_UNIVERSAL = 293 -- GetModifierBecomeUniversal
MODIFIER_PROPERTY_BONUSDAMAGEOUTGOING_PERCENTAGE = 40 -- GetModifierBonusDamageOutgoing_Percentage
MODIFIER_PROPERTY_BONUS_DAY_VISION = 147 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_DAY_VISION_PERCENTAGE = 148 -- GetBonusDayVisionPercentage
MODIFIER_PROPERTY_BONUS_LOTUS_HEAL = 316 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 149 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 150 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_UPHILL_MISS_CHANCE = 311 -- GetModifierBonusUphillMissChance
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 151 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 262 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 171 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 172 -- Unused
MODIFIER_PROPERTY_BUYBACK_PENALTY_PERCENT = 307 -- GetModifierBuybackPenaltyPercent
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 251 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 125 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 106 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CAST_RANGE_BONUS_PERCENTAGE = 107 -- GetModifierCastRangeBonusPercentage
MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 109 -- GetModifierCastRangeBonusStacking
MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 108 -- GetModifierCastRangeBonusTarget
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 240 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_CONVERT_MANA_COST_TO_HEALTH_COST = 236 -- GetModifierConvertManaCostToHealthCost
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 123 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 124 -- GetModifierPercentageCooldownOngoing
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 269 -- GetModifierPercentageCooldownStacking
MODIFIER_PROPERTY_COOLDOWN_REDUCTION_CONSTANT = 33 -- GetModifierCooldownReduction_Constant
MODIFIER_PROPERTY_CREATE_BONUS_ILLUSION_CHANCE = 322 -- GetModifierCreateBonusIllusionChance
MODIFIER_PROPERTY_CREATE_BONUS_ILLUSION_COUNT = 323 -- GetModifierCreateBonusIllusionCount
MODIFIER_PROPERTY_CREEP_DENY_PERCENT = 312 -- GetModifierCreepDenyPercent
...
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_MULTIPLICATIVE = 283 -- GetModifierDamageOutgoing_PercentageMultiplicative
MODIFIER_PROPERTY_DEATHGOLDCOST = 131 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 146 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 166 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 238 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DISASSEMBLE_ANYTHING = 309 -- GetModifierDisassembleAnything
MODIFIER_PROPERTY_DODGE_PROJECTILE = 174 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 255 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 63 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 133 -- GetModifierPercentageExpRateBoost
MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 95 -- GetModifierExtraHealthBonus
MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 98 -- GetModifierExtraHealthPercentage
MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 96 -- GetModifierExtraManaBonus
MODIFIER_PROPERTY_EXTRA_MANA_BONUS_PERCENTAGE = 97 -- GetModifierExtraManaBonusPercentage
MODIFIER_PROPERTY_EXTRA_MANA_PERCENTAGE = 99 -- GetModifierExtraManaPercentage
MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 94 -- GetModifierExtraStrengthBonus
MODIFIER_PROPERTY_FAIL_ATTACK = 279 -- GetModifierPropetyFailAttack
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 30 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 152 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_MANA_REGEN = 310 -- GetModifierFixedManaRegen
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 153 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 237 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_FORCE_MAX_HEALTH = 299 -- GetModifierForceMaxHealth
MODIFIER_PROPERTY_FORCE_MAX_MANA = 300 -- GetModifierForceMaxMana
MODIFIER_PROPERTY_FOW_TEAM = 314 -- GetModifierFoWTeam
MODIFIER_PROPERTY_GOLD_RATE_BOOST = 134 -- GetModifierPercentageGoldRateBoost
MODIFIER_PROPERTY_HAS_BONUS_NEUTRAL_ITEM_CHOICE = 298 -- GetModifierHasBonusNeutralItemChoice
MODIFIER_PROPERTY_HEALTHBAR_PIPS = 275 -- GetModifierHealthBarPips
MODIFIER_PROPERTY_HEALTHCOST_PERCENTAGE = 129 -- GetModifierPercentageHealthcost
MODIFIER_PROPERTY_HEALTHCOST_PERCENTAGE_STACKING = 130 -- GetModifierPercentageHealthcostStacking
MODIFIER_PROPERTY_HEALTHCOST_REDUCTION_CONSTANT = 35 -- GetModifierHealthcostReduction_Constant
MODIFIER_PROPERTY_HEALTH_BONUS = 92 -- GetModifierHealthBonus
MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 89 -- GetModifierConstantHealthRegen
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 90 -- GetModifierHealthRegenPercentage
MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE_UNIQUE = 91 -- GetModifierHealthRegenPercentageUnique
...
MODIFIER_PROPERTY_HEROFACET_OVERRIDE = 331 -- GetModifierHeroFacetOverride
...
MODIFIER_PROPERTY_HP_REGEN_MULTIPLIER_PRE_AMPLIFICATION = 330 -- GetModifierHPRegenMultiplierPreAmplification
MODIFIER_PROPERTY_IGNORE_ATTACKSPEED_LIMIT = 32 -- GetModifierAttackSpeed_Limit
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 239 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 250 -- GetModifierIgnoreCooldown
MODIFIER_PROPERTY_IGNORE_MOVESPEED_LIMIT = 27 -- GetModifierIgnoreMovespeedLimit
MODIFIER_PROPERTY_IGNORE_PHYSICAL_ARMOR = 78 -- GetModifierIgnorePhysicalArmor
MODIFIER_PROPERTY_ILLUSION_LABEL = 159 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT = 276 -- GetModifierIncomingDamageConstant
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST = 282 -- MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST
...
MODIFIER_PROPERTY_IS_ILLUSION = 158 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 228 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 229 -- GetModifierShard
MODIFIER_PROPERTY_ITEM_SELLBACK_COST = 308 -- GetModifierItemSellbackCost
MODIFIER_PROPERTY_KILL_STREAK_BONUS_GOLD_PERCENTAGE = 329 -- GetModifierKillStreakBonusGoldPercentage
MODIFIER_PROPERTY_KNOCKBACK_AMPLIFICATION_PERCENTAGE = 274 -- GetModifierKnockbackAmplification_Percentage
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 52 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 233 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 137 -- GetModifierMagical_ConstantBlock
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BASE_REDUCTION = 79 -- GetModifierMagicalResistanceBaseReduction
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 81 -- GetModifierMagicalResistanceBonus
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_ILLUSIONS = 82 -- GetModifierMagicalResistanceBonusIllusions
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS_UNIQUE = 83 -- GetModifierMagicalResistanceBonusUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 84 -- GetModifierMagicalResistanceDecrepifyUnique
MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DIRECT_MODIFICATION = 80 -- GetModifierMagicalResistanceDirectModification
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 127 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 128 -- GetModifierPercentageManacostStacking
MODIFIER_PROPERTY_MANACOST_REDUCTION_CONSTANT = 34 -- GetModifierManacostReduction_Constant
MODIFIER_PROPERTY_MANA_BONUS = 93 -- GetModifierManaBonus
MODIFIER_PROPERTY_MANA_DRAIN_AMPLIFY_PERCENTAGE = 55 -- GetModifierManaDrainAmplify_Percentage
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 86 -- GetModifierConstantManaRegen
MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 87 -- GetModifierConstantManaRegenUnique
MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 88 -- GetModifierTotalPercentageManaRegen
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 114 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 176 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_ATTRIBUTE_LEVEL = 334 -- MinAttributeLevel
MODIFIER_PROPERTY_MIN_HEALTH = 154 -- GetMinHealth
MODIFIER_PROPERTY_MIN_PHYSICAL_ARMOR = 77 -- GetModifierMinPhysicalArmor
MODIFIER_PROPERTY_MISS_PERCENTAGE = 70 -- GetModifierMiss_Percentage
MODIFIER_PROPERTY_MISS_PERCENTAGE_TARGET = 327 -- GetModifierMiss_Percentage_Target
MODIFIER_PROPERTY_MODEL_CHANGE = 223 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 224 -- GetModifierModelScale
MODIFIER_PROPERTY_MODEL_SCALE_ANIMATE_TIME = 225 -- GetModifierModelScaleAnimateTime
MODIFIER_PROPERTY_MODEL_SCALE_CONSTANT = 227 -- GetModifierModelScaleConstant
MODIFIER_PROPERTY_MODEL_SCALE_USE_IN_OUT_EASE = 226 -- GetModifierModelScaleUseInOutEase
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 264 -- GetModifierMoveSpeedReductionPercentage
...
MODIFIER_PROPERTY_NO_FREE_TP_SCROLL_ON_DEATH = 297 -- GetModifierNoFreeTPScrollOnDeath
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 241 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 242 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 142 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 143 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 11 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 169 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PACK_RAT = 272 -- GetModifierIsPackRat
MODIFIER_PROPERTY_PERCENTAGE_DEATHGOLDCOST = 132 -- GetModifierPercentageDeathGoldCost
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 15 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICALDAMAGEOUTGOING_PERCENTAGE = 273 -- GetModifierPhysicalDamageOutgoing_Percentage
...
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 138 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 139 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 135 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 178 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 136 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PREREDUCE_INCOMING_DAMAGE_MULT = 280 -- GetModifierPrereduceIncomingDamage_Mult
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 248 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 12 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 177 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_NAME = 117 -- GetModifierProjectileName
MODIFIER_PROPERTY_PROJECTILE_SPEED = 288 -- GetModifierProjectileSpeed
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 115 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 116 -- GetModifierProjectileSpeedBonusPercentage
MODIFIER_PROPERTY_PROJECTILE_SPEED_TARGET = 289 -- GetModifierProjectileSpeedTarget
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 234 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_PSEUDORANDOM_BONUS = 324 -- GetModofierPropertyPseudoRandomBonus
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 230 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REFLECT_SPELL = 145 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 118 -- ReincarnateTime
MODIFIER_PROPERTY_REINCARNATION_SUPPRESS_FX = 119 -- ReincarnateSuppressFX
MODIFIER_PROPERTY_RESPAWNTIME = 120 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 121 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 122 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SHARE_XPRUNE = 296 -- GetModifierShareXPRune
MODIFIER_PROPERTY_SKIP_ATTACK_REGULATOR = 326 -- GetSkipAttackRegulator
MODIFIER_PROPERTY_SLOW_RESISTANCE_STACKING = 286 -- GetModifierSlowResistance_Stacking
MODIFIER_PROPERTY_SLOW_RESISTANCE_UNIQUE = 285 -- GEtModifierSlowResistance_Unique
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 235 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_SPELL_REDIRECT_TARGET = 270 -- GetModifierSpellRedirectTarget
MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 101 -- GetModifierBonusStats_Agility
MODIFIER_PROPERTY_STATS_AGILITY_BONUS_PERCENTAGE = 104 -- GetModifierBonusStats_Agility_Percentage
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 102 -- GetModifierBonusStats_Intellect
MODIFIER_PROPERTY_STATS_INTELLECT_BONUS_PERCENTAGE = 105 -- GetModifierBonusStats_Intellect_Percentage
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 100 -- GetModifierBonusStats_Strength
MODIFIER_PROPERTY_STATS_STRENGTH_BONUS_PERCENTAGE = 103 -- GetModifierBonusStats_Strength_Percentage
...
MODIFIER_PROPERTY_STRONG_ILLUSION = 160 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 161 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 162 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 261 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_CRIT = 305 -- GetSuppressCrit
MODIFIER_PROPERTY_SUPPRESS_FULLSCREEN_DEATH_FX = 281 -- GetModifierSuppressFullscreenDeathFX
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 259 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 247 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TICK_GOLD_MULTIPLIER = 284 -- GetModifierTickGold_Multiplier
MODIFIER_PROPERTY_TOOLTIP = 222 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 256 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 44 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 141 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 140 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 231 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 232 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 175 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_CONSTANT = 271 -- GetModifierTurnRateConstant
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 165 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 164 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 173 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 170 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 252 -- GetVisualZDelta
MODIFIER_PROPERTY_VISUAL_Z_SPEED_BASE_OVERRIDE = 253 -- GetVisualZSpeedBaseOverride
MODIFIER_PROPERTY_XP_DURING_DEATH = 163 -- GetModifierXPDuringDeath
...
---[[ CBaseAnimatingActivity:ActiveSequenceDuration  Returns the duration in seconds of the active sequence. ]]
-- @return float
function CBaseAnimatingActivity:ActiveSequenceDuration(  ) end

---[[ CBaseAnimatingActivity:GetCycle  Get the cycle of the animation. ]]
-- @return float
function CBaseAnimatingActivity:GetCycle(  ) end

---[[ CBaseAnimatingActivity:GetSequence  Returns the name of the active sequence. ]]
-- @return string
function CBaseAnimatingActivity:GetSequence(  ) end

---[[ CBaseAnimatingActivity:IsSequenceFinished  Ask whether the main sequence is done playing. ]]
-- @return bool
function CBaseAnimatingActivity:IsSequenceFinished(  ) end

---[[ CBaseAnimatingActivity:ResetSequence  Sets the active sequence by name, resetting the current cycle. ]]
-- @return void
-- @param pSequenceName string
function CBaseAnimatingActivity:ResetSequence( pSequenceName ) end

---[[ CBaseAnimatingActivity:SequenceDuration  Returns the duration in seconds of the given sequence name. ]]
-- @return float
-- @param pSequenceName string
function CBaseAnimatingActivity:SequenceDuration( pSequenceName ) end

---[[ CBaseAnimatingActivity:SetCycle  Set the cycle of the animation. ]]
-- @return void
-- @param flCycle float
function CBaseAnimatingActivity:SetCycle( flCycle ) end

---[[ CBaseAnimatingActivity:SetPoseParameter  Set the specified pose parameter to the specified value. ]]
-- @return float
-- @param szName string
-- @param fValue float
function CBaseAnimatingActivity:SetPoseParameter( szName, fValue ) end

---[[ CBaseAnimatingActivity:SetSequence  Sets the active sequence by name, keeping the current cycle. ]]
-- @return void
-- @param pSequenceName string
function CBaseAnimatingActivity:SetSequence( pSequenceName ) end

---[[ CBaseAnimatingActivity:StopAnimation  Stop the current animation by setting playback rate to 0.0. ]]
-- @return void
...
---[[ CBaseEntity:IsDOTANPC  Is this entity a Dota NPC? ]]
-- @return bool
...
---[[ CBaseEntity:IsPlayer  Back compat: Is this entity a player pawn *or* controller? ]]
-- @return bool
...
---[[ CDOTABaseAbility:EnableAbilityChargesOnTalentUpgrade   ]]
-- @return void
-- @param hAbility handle
-- @param pszTalentName string
function CDOTABaseAbility:EnableAbilityChargesOnTalentUpgrade( hAbility, pszTalentName ) end
...
---[[ CDOTABaseAbility:ForceSetFrozenCooldown   ]]
-- @return void
-- @param nValue int
function CDOTABaseAbility:ForceSetFrozenCooldown( nValue ) end

---[[ CDOTABaseAbility:GetAOERadius   ]]
-- @return float
function CDOTABaseAbility:GetAOERadius(  ) end

---[[ CDOTABaseAbility:GetAbilityChargeRestoreTime   ]]
-- @return float
-- @param iLevel int
function CDOTABaseAbility:GetAbilityChargeRestoreTime( iLevel ) end
...
---[[ CDOTABaseAbility:GetCastPointModifier   ]]
-- @return float
...
---[[ CDOTABaseAbility:GetChannelledHealthCostPerSecond   ]]
-- @return int
-- @param iLevel int
function CDOTABaseAbility:GetChannelledHealthCostPerSecond( iLevel ) end
...
---[[ CDOTABaseAbility:GetEffectiveHealthCost   ]]
-- @return int
-- @param iLevel int
function CDOTABaseAbility:GetEffectiveHealthCost( iLevel ) end

---[[ CDOTABaseAbility:GetEffectiveManaCost   ]]
-- @return int
-- @param iLevel int
function CDOTABaseAbility:GetEffectiveManaCost( iLevel ) end
...
---[[ CDOTABaseAbility:GetHealthCost   ]]
-- @return int
-- @param iLevel int
function CDOTABaseAbility:GetHealthCost( iLevel ) end

---[[ CDOTABaseAbility:GetHeroLevelRequiredToUpgrade   ]]
-- @return int
function CDOTABaseAbility:GetHeroLevelRequiredToUpgrade(  ) end

---[[ CDOTABaseAbility:GetInitialAbilityCharges   ]]
-- @return int
-- @param iLevel int
...
---[[ CDOTABaseAbility:PayHealthCost   ]]
-- @return void
...
---[[ CDOTABaseAbility:RefundHealthCost   ]]
-- @return void
...
-- @return void
-- @param bMana bool
-- @param bUseHealth bool
-- @param bGold bool
-- @param bCooldown bool
function CDOTABaseAbility:UseResources( bMana, bUseHealth, bGold, bCooldown ) end

---[[ CDOTABaseGameMode:AddAbilityUpgradeToWhitelist  const char* pszAbilityName ]]
-- @return void
...
---[[ CDOTABaseGameMode:EnableAbilityUpgradeWhitelist  bool bEnabled ]]
-- @return void
-- @param bEnabled bool
...
---[[ CDOTABaseGameMode:GetAnnouncerGameModeAnnounceDisabled  Is the announcer announcing the mode / saying Choose Your Hero on start of custom games disabled? ]]
-- @return bool
...
---[[ CDOTABaseGameMode:GetWaterRuneLastSpawnTime  Gets the time from game start during which water runes spawn ]]
-- @return float
function CDOTABaseGameMode:GetWaterRuneLastSpawnTime(  ) end

---[[ CDOTABaseGameMode:IsAbilityUpgradeWhitelisted  const char* pszAbilityName ]]
-- @return bool
-- @param pszAbilityName string
...
---[[ CDOTABaseGameMode:RemoveAbilityUpgradeFromWhitelist  const char* pszAbilityName ]]
-- @return void
-- @param pszAbilityName string
...
---[[ CDOTABaseGameMode:SetAnnouncerGameModeAnnounceDisabled  Disables the announcer announcing the mode / saying Choose Your Hero on start of custom games. ]]
-- @return void
-- @param bDisabled bool
function CDOTABaseGameMode:SetAnnouncerGameModeAnnounceDisabled( bDisabled ) end
...
---[[ CDOTABaseGameMode:SetCanSellAnywhere  bool bAllow ]]
-- @return void
-- @param bAllow bool
...
---[[ CDOTABaseGameMode:SetCustomScanMaxCharges  Set a custom max charges for team Scan ability. ]]
-- @return void
-- @param iMaxCharges int
function CDOTABaseGameMode:SetCustomScanMaxCharges( iMaxCharges ) end
...
---[[ CDOTABaseGameMode:SetDeathTipsDisabled  Disables chat tips on death. ]]
-- @return void
-- @param bDisabled bool
function CDOTABaseGameMode:SetDeathTipsDisabled( bDisabled ) end
...
---[[ CDOTABaseGameMode:SetForcedHUDSkin  Specify a HUD skin that is forced on for this game mode. ]]
-- @return void
-- @param pValue string
...
---[[ CDOTABaseGameMode:SetGiveFreeTPOnDeath  bool bGive ]]
-- @return void
-- @param bGive bool
...
---[[ CDOTABaseGameMode:SetInnateMeleeDamageBlockAmount  Set the amount blocked innately by melee heroes. ]]
-- @return void
-- @param nAmount int
function CDOTABaseGameMode:SetInnateMeleeDamageBlockAmount( nAmount ) end

---[[ CDOTABaseGameMode:SetInnateMeleeDamageBlockPerLevelAmount  Set the amount innately blocked by melee heroes gained per level. ]]
-- @return void
-- @param nPerLevelAmount int
function CDOTABaseGameMode:SetInnateMeleeDamageBlockPerLevelAmount( nPerLevelAmount ) end

---[[ CDOTABaseGameMode:SetInnateMeleeDamageBlockPercent  Set the percent chance a melee hero will innately block damage. ]]
-- @return void
-- @param nPercent int
...
---[[ CDOTABaseGameMode:SetLuaGameMode   ]]
-- @return void
-- @param hScript handle
function CDOTABaseGameMode:SetLuaGameMode( hScript ) end
...
---[[ CDOTABaseGameMode:SetPlayerHeroAvailabilityFiltered  bool bFilter ]]
-- @return void
-- @param bFilter bool
...
---[[ CDOTABaseGameMode:SetWaterRuneLastSpawnTime  Sets the time from game start during which water runes spawn ]]
-- @return void
-- @param flValue float
function CDOTABaseGameMode:SetWaterRuneLastSpawnTime( flValue ) end
...
---[[ CDOTABaseGameMode:SetXPRuneSpawnInterval  Set xp rune spawn rate ]]
-- @return void
-- @param flInterval float
function CDOTABaseGameMode:SetXPRuneSpawnInterval( flInterval ) end

---[[ CDOTABaseGameMode:ShouldGiveFreeTPOnDeath   ]]
-- @return bool
...
---[[ CDOTAPlayerController:CheckForCourierSpawning  Attempt to spawn the appropriate couriers for this mode. ]]
-- @return handle
-- @param hHero handle
function CDOTAPlayerController:CheckForCourierSpawning( hHero ) end

---[[ CDOTAPlayerController:GetAssignedHero  Get the player's hero. ]]
-- @return handle
function CDOTAPlayerController:GetAssignedHero(  ) end

---[[ CDOTAPlayerController:GetPlayerID  Get the player's official PlayerID; notably is -1 when the player isn't yet on a team. ]]
-- @return int
function CDOTAPlayerController:GetPlayerID(  ) end

---[[ CDOTAPlayerController:MakeRandomHeroSelection  Randoms this player's hero. ]]
-- @return void
function CDOTAPlayerController:MakeRandomHeroSelection(  ) end

---[[ CDOTAPlayerController:SetAssignedHeroEntity  Sets this player's hero . ]]
-- @return void
-- @param hHero handle
function CDOTAPlayerController:SetAssignedHeroEntity( hHero ) end

---[[ CDOTAPlayerController:SetKillCamUnit  Set the kill cam unit for this hero. ]]
-- @return void
-- @param hEntity handle
function CDOTAPlayerController:SetKillCamUnit( hEntity ) end

---[[ CDOTAPlayerController:SetMusicStatus  (nMusicStatus, flIntensity) - Set the music status for this player, note this will only really apply if dota_music_battle_enable is off. ]]
-- @return void
-- @param nMusicStatus int
-- @param flIntensity float
function CDOTAPlayerController:SetMusicStatus( nMusicStatus, flIntensity ) end

---[[ CDOTAPlayerController:SetSelectedHero  Sets this player's hero selection. ]]
-- @return void
-- @param pszHeroName string
function CDOTAPlayerController:SetSelectedHero( pszHeroName ) end

---[[ CDOTAPlayerController:SpawnCourierAtPosition  Spawn a courier for this player at the given position. ]]
-- @return handle
-- @param vLocation Vector
...
---[[ CDOTA_Ability_Lua:GetAbilityChargeRestoreTime   ]]
-- @return float
-- @param iLevel int
function CDOTA_Ability_Lua:GetAbilityChargeRestoreTime( iLevel ) end
...
---[[ CDOTA_Ability_Lua:GetChannelStartTime  Return the channel start time of this ability. ]]
-- @return float
...
---[[ CDOTA_Ability_Lua:GetChannelledHealthCostPerSecond  Return health cost per second of channeling at the given level (-1 is current). ]]
-- @return int
-- @param iLevel int
function CDOTA_Ability_Lua:GetChannelledHealthCostPerSecond( iLevel ) end
...
---[[ CDOTA_Ability_Lua:GetCustomHudErrorMessage  (DOTA_INVALID_ORDERS nReason) Return the error string of a failed order. ]]
-- @return string
-- @param nReason int
function CDOTA_Ability_Lua:GetCustomHudErrorMessage( nReason ) end
...
---[[ CDOTA_Ability_Lua:GetHealthCost  Return health cost at the given level (-1 is current). ]]
-- @return int
-- @param iLevel int
function CDOTA_Ability_Lua:GetHealthCost( iLevel ) end
...
---[[ CDOTA_Ability_Lua:IsAttributeBonus  Is this ability an Attribute Bonus. ]]
-- @return bool
...
---[[ CDOTA_Ability_Lua:OnAbilityUpgrade   ]]
-- @return void
-- @param hUpgradeAbility handle
function CDOTA_Ability_Lua:OnAbilityUpgrade( hUpgradeAbility ) end
...
-- @return void
-- @param flTime float
-- @param flTimeDisparityTolerance float
...
---[[ CDOTA_BaseNPC:CanBeSeenByAnyOpposingTeam   ]]
-- @return bool
...
---[[ CDOTA_BaseNPC:ConsumeItem  Consume the item, deleting it from the inventory and granting the hero the specified bonuses. ]]
-- @return void
-- @param hItem handle
function CDOTA_BaseNPC:ConsumeItem( hItem ) end
...
function CDOTA_BaseNPC:GetAttackSpeed( bIgnoreTempAttackSpeed ) end
...
-- @return float
-- @param bIgnoreTempAttackSpeed bool
function CDOTA_BaseNPC:GetAttacksPerSecond( bIgnoreTempAttackSpeed ) end
...
-- @return float
-- @param bIgnoreTempAttackSpeed bool
function CDOTA_BaseNPC:GetIncreasedAttackSpeed( bIgnoreTempAttackSpeed ) end
...
---[[ CDOTA_BaseNPC:GetRemainingPathLength   ]]
-- @return float
...
-- @return float
-- @param bIgnoreTempAttackSpeed bool
function CDOTA_BaseNPC:GetSecondsPerAttack( bIgnoreTempAttackSpeed ) end
...
---[[ CDOTA_BaseNPC:HealWithParams  Heal this unit (with more parameters) ]]
-- @return void
-- @param flAmount float
-- @param hInflictor handle
-- @param bLifesteal bool
-- @param bAmplify bool
-- @param hSource handle
-- @param bSpellLifesteal bool
...
---[[ CDOTA_BaseNPC:IsBossCreature  Is this unit a Boss Creature? (used by custom games) ]]
-- @return bool
...
---[[ CDOTA_BaseNPC:IsHeroWard  Is this a Hero Ward? ]]
-- @return bool
...
---[[ CDOTA_BaseNPC:IsStrongIllusion   ]]
-- @return bool
...
---[[ CDOTA_BaseNPC:IsUntargetableFrom   ]]
-- @return bool
-- @param pTargettingSource handle
function CDOTA_BaseNPC:IsUntargetableFrom( pTargettingSource ) end

---[[ CDOTA_BaseNPC:IsWard  Is this a Ward? ]]
-- @return bool
function CDOTA_BaseNPC:IsWard(  ) end

---[[ CDOTA_BaseNPC:IsZombie  Is this entity an Undying Zombie? ]]
-- @return bool
...
---[[ CDOTA_BaseNPC:OnCommandMoveToDirection  Tells the underlying AI to move in the given direction, skipping Dota orders ]]
-- @return void
-- @param pos Vector
...
---[[ CDOTA_BaseNPC:RemoveAllModifiersOfName  Removes all copies of a modifier. ]]
-- @return void
-- @param pszScriptName string
...
---[[ CDOTA_BaseNPC:Script_GetMagicalArmorValue  Returns current magical armor value. ]]
-- @return float
-- @param bUseExperimentalFormula bool
-- @param inflictor handle
function CDOTA_BaseNPC:Script_GetMagicalArmorValue( bUseExperimentalFormula, inflictor ) end

---[[ CDOTA_BaseNPC:Script_IsDeniable   ]]
-- @return bool
function CDOTA_BaseNPC:Script_IsDeniable(  ) end

---[[ CDOTA_BaseNPC:Script_ReduceMana  Remove mana from this unit, this can be used for involuntary mana loss, not for mana that is spent. ]]
-- @return float
-- @param flMana float
-- @param hAbility handle
function CDOTA_BaseNPC:Script_ReduceMana( flMana, hAbility ) end
...
---[[ CDOTA_BaseNPC:SetFollowRange   ]]
-- @return void
-- @param flFollowRange float
...
---[[ CDOTA_BaseNPC:SetShouldComputeRemainingPathLength   ]]
-- @return void
-- @param bCompute bool
function CDOTA_BaseNPC:SetShouldComputeRemainingPathLength( bCompute ) end
...
---[[ CDOTA_BaseNPC:StartGestureWithFadeAndPlaybackRate  Add the given gesture activity faded according to to the parameters and with a playback rate override. ]]
-- @return void
-- @param nActivity int
-- @param fFadeIn float
-- @param fFadeOut float
-- @param flRate float
function CDOTA_BaseNPC:StartGestureWithFadeAndPlaybackRate( nActivity, fFadeIn, fFadeOut, flRate ) end
...
---[[ CDOTA_BaseNPC_Creature:SetAggroOnOwnerOnDamage  Does this creature aggro on the owner of the attacking unit when taking damage? ]]
-- @return void
-- @param bAggro bool
...
---[[ CDOTA_BaseNPC_Creature:SetEconItemGroup  Switches visible econ item group. ]]
-- @return void
-- @param nGroup int
function CDOTA_BaseNPC_Creature:SetEconItemGroup( nGroup ) end
...
---[[ CDOTA_BaseNPC_Hero:GetHeroFacetID   ]]
-- @return unsigned
...
-- @return float
-- @param bIgnoreTempAttackSpeed bool
function CDOTA_BaseNPC_Hero:GetIncreasedAttackSpeed( bIgnoreTempAttackSpeed ) end

---[[ CDOTA_BaseNPC_Hero:GetIntellect   ]]
-- @return float
-- @param bSkipNoConsume bool
function CDOTA_BaseNPC_Hero:GetIntellect( bSkipNoConsume ) end
...
---[[ CDOTA_CustomUIManager:DynamicHud_Create  Create a new custom UI HUD element for the specified player(s). ( PlayerID_t PlayerID /*-1 means everyone*/, string ElementID /* should be unique */, string LayoutFileName, table DialogVariables /* can be nil */ ) ]]
-- @return void
-- @param int_1 int
-- @param string_2 string
-- @param string_3 string
...
---[[ CDOTA_CustomUIManager:DynamicHud_Destroy  Destroy a custom hud element ( PlayerID_t PlayerID /*-1 means everyone*/, string ElementID ) ]]
-- @return void
-- @param int_1 int
-- @param string_2 string
function CDOTA_CustomUIManager:DynamicHud_Destroy( int_1, string_2 ) end

---[[ CDOTA_CustomUIManager:DynamicHud_SetDialogVariables  Add or modify dialog variables for an existing custom hud element ( PlayerID_t PlayerID /*-1 means everyone*/, string ElementID, table DialogVariables ) ]]
-- @return void
-- @param int_1 int
-- @param string_2 string
-- @param handle_3 handle
...
---[[ CDOTA_CustomUIManager:DynamicHud_SetVisible  Toggle the visibility of an existing custom hud element ( PlayerID_t PlayerID /*-1 means everyone*/, string ElementID, bool Visible ) ]]
-- @return void
-- @param int_1 int
-- @param string_2 string
-- @param bool_3 bool
...
function CDOTA_Item:LaunchLoot( bAutoUse, flHeight, flDuration, vEndPoint, hTeleportOwner ) end
...
---[[ CDOTA_Item_EmptyBottle:ClearStoredRune  Clear the stored rune. ]]
-- @return void
function CDOTA_Item_EmptyBottle:ClearStoredRune(  ) end

---[[ CDOTA_Item_EmptyBottle:OnRune  Place a rune in the bottle. ]]
-- @return bool
-- @param iRuneType int
function CDOTA_Item_EmptyBottle:OnRune( iRuneType ) end

---[[ CDOTA_Item_EmptyBottle:SetStoredRune  Set the stored rune. ]]
-- @return void
-- @param iRuneType int
...
---[[ CDOTA_Item_Lua:GetChannelStartTime  Return the channel start time of this ability. ]]
-- @return float
...
---[[ CDOTA_Item_Lua:GetChannelledHealthCostPerSecond  Return health cost per second of channeling at the given level (-1 is current). ]]
-- @return int
-- @param iLevel int
function CDOTA_Item_Lua:GetChannelledHealthCostPerSecond( iLevel ) end
...
---[[ CDOTA_Item_Lua:GetCustomHudErrorMessage  (DOTA_INVALID_ORDERS nReason) Return the error string of a failed order. ]]
-- @return string
-- @param nReason int
function CDOTA_Item_Lua:GetCustomHudErrorMessage( nReason ) end
...
---[[ CDOTA_Item_Lua:GetHealthCost  Return health cost at the given level (-1 is current). ]]
-- @return int
-- @param iLevel int
function CDOTA_Item_Lua:GetHealthCost( iLevel ) end
...
---[[ CDOTA_Item_Physical:IsLoot  Is this drop flagged as a loot drop? ]]
-- @return bool
...
---[[ CDOTA_Item_Physical:SetIsLoot  Set if this drop is flagged as a loot drop ]]
-- @return void
-- @param bIsLoot bool
function CDOTA_Item_Physical:SetIsLoot( bIsLoot ) end
...
---[[ CDOTA_PlayerResource:ClearPlayer   ]]
-- @return void
-- @param iPlayerID int
function CDOTA_PlayerResource:ClearPlayer( iPlayerID ) end
...
---[[ CDOTA_PlayerResource:GetEventGameUpgrades  (nPlayerID) ]]
-- @return handle
-- @param nPlayerID int
...
---[[ CDOTA_PlayerResource:GetLabyrinthEventGameHeroUnlocks  (nPlayerID) ]]
-- @return handle
-- @param nPlayerID int
...
---[[ CDOTA_PlayerResource:GetNetworkedEventActionClaimCount  (nPlayerID, eEvent, nActionID) ]]
-- @return int
-- @param nPlayerID int
-- @param nEventID int
-- @param unActionID unsigned
function CDOTA_PlayerResource:GetNetworkedEventActionClaimCount( nPlayerID, nEventID, unActionID ) end

---[[ CDOTA_PlayerResource:GetNetworkedEventActionClaimCountByName  (nPlayerID, eEvent, pActionName) ]]
-- @return int
-- @param nPlayerID int
-- @param nEventID int
-- @param pActionName string
function CDOTA_PlayerResource:GetNetworkedEventActionClaimCountByName( nPlayerID, nEventID, pActionName ) end
...
---[[ CDOTA_PlayerResource:HasSetNetworkedEventActionClaimCount   ]]
-- @return bool
...
---[[ CDOTA_PlayerResource:RecordEventActionGrant   ]]
-- @return void
-- @param iPlayerID int
-- @param eEvent int
...
---[[ CDOTA_PlayerResource:RecordEventActionGrantForPrimaryEvent   ]]
-- @return void
-- @param iPlayerID int
...
---[[ CDOTA_PlayerResource:ReplaceHeroWithNoTransfer  (playerID, heroClassName, gold, XP) - replaces the player's hero with a new one of the specified class, gold and XP, without transferring items/abilities if same hero ]]
-- @return handle
-- @param iPlayerID int
-- @param pszHeroClass string
-- @param nGold int
...
---[[ CDOTA_Unit_Courier:RespawnCourier  Respawn the courier. ]]
-- @return void
...
---[[ CDOTA_Unit_CustomGameAnnouncerAghanim:SetAnimation  Set the animation sequence for this entity. ]]
-- @return void
-- @param pAnimation string
function CDOTA_Unit_CustomGameAnnouncerAghanim:SetAnimation( pAnimation ) end

---[[ CDOTA_Unit_CustomGameAnnouncerAghanim:SetServerAuthoritative  Determines whether response criteria is matched on server or client ]]
-- @return void
-- @param bIsServerAuthoritative bool
function CDOTA_Unit_CustomGameAnnouncerAghanim:SetServerAuthoritative( bIsServerAuthoritative ) end
