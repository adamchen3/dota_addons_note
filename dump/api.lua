...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 203 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 200 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 201 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 199 -- OnAbilityStart
MODIFIER_EVENT_ON_ABILITY_TOGGLED = 353 -- OnAbilityToggled
MODIFIER_EVENT_ON_ASSIST = 255 -- OnAssist
MODIFIER_EVENT_ON_ATTACK = 192 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 213 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 195 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 269 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 194 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 258 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 193 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 190 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 266 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 191 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 276 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 202 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 227 -- OnBuildingKilled
MODIFIER_EVENT_ON_CLEAVE_ATTACK_LANDED = 342 -- OnCleaveAttackLanded
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 211 -- OnDamageCalculated
MODIFIER_EVENT_ON_DAMAGE_HPLOSS = 304 -- OnDamageHPLoss
MODIFIER_EVENT_ON_DAY_STARTED = 330 -- OnDayStarted
MODIFIER_EVENT_ON_DEATH = 214 -- OnDeath
MODIFIER_EVENT_ON_DEATH_COMPLETED = 215 -- OnDeathCompleted
MODIFIER_EVENT_ON_DEATH_PREVENTED = 207 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 253 -- OnDominated
MODIFIER_EVENT_ON_FORCE_PROC_MAGIC_STICK = 303 -- OnForceProcMagicStick
MODIFIER_EVENT_ON_FOW_TEAM_CHANGED = 351 -- OnFoWTeamChanged
MODIFIER_EVENT_ON_HEALTH_GAINED = 222 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 226 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_BEGIN_DYING = 324 -- OnHeroBeginDying
MODIFIER_EVENT_ON_HERO_KILLED = 225 -- OnHeroKilled
MODIFIER_EVENT_ON_KILL = 254 -- OnKill
MODIFIER_EVENT_ON_MAGIC_DAMAGE_CALCULATED = 212 -- OnMagicDamageCalculated
MODIFIER_EVENT_ON_MANA_GAINED = 223 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 228 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 229 -- OnModifierAdded
MODIFIER_EVENT_ON_MODIFIER_REMOVED = 230 -- OnModifierRemoved
MODIFIER_EVENT_ON_MUTE_DAMAGE_ABILITIES = 313 -- OnMuteDamageAbilities
MODIFIER_EVENT_ON_ORB_EFFECT = 209 -- Unused
MODIFIER_EVENT_ON_ORDER = 197 -- OnOrder
MODIFIER_EVENT_ON_PREDEBUFF_APPLIED = 277 -- OnPreDebuffApplied
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 210 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 204 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 196 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 267 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 205 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 216 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 221 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 189 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_HEALTH = 218 -- OnSpentHealth
MODIFIER_EVENT_ON_SPENT_MANA = 217 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 208 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 206 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 224 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TAKEDAMAGE_POST_UNAVOIDABLE_BLOCK = 312 -- OnTakeDamagePostUnavoidableBlock
MODIFIER_EVENT_ON_TELEPORTED = 220 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 219 -- OnTeleporting
MODIFIER_EVENT_ON_TIER_TOKEN_REROLLED = 348 -- OnTierTokenRerolled
MODIFIER_EVENT_ON_TREE_CUT_DOWN = 341 -- OnTreeCutDown
MODIFIER_EVENT_ON_UNIT_MOVED = 198 -- OnUnitMoved
MODIFIER_EVENT_SPELL_APPLIED_SUCCESSFULLY = 286 -- OnSpellAppliedSuccessfully
MODIFIER_FUNCTION_INVALID = 65535
MODIFIER_FUNCTION_LAST = 355
MODIFIER_PROPERTY_ABILITY_LAYOUT = 252 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABILITY_POINTS = 315 -- GetModifierAbilityPoints
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 160 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 159 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 161 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 148 -- GetAbsorbSpell
MODIFIER_PROPERTY_ADDITIONAL_NEUTRAL_ITEM_DROPS = 337 -- GetModifierAdditionalNutralItemDrops
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 172 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 184 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 173 -- GetAllowEtherealAttack
MODIFIER_PROPERTY_AOE_BONUS_CONSTANT = 310 -- GetModifierAoEBonusConstant
MODIFIER_PROPERTY_AOE_BONUS_CONSTANT_STACKING = 311 -- GetModifierAoEBonusConstantStacking
MODIFIER_PROPERTY_AOE_BONUS_PERCENTAGE = 296 -- GetModifierAoEBonusPercentage
MODIFIER_PROPERTY_ATTACKSPEED_ABSOLUTE_MAX = 322 -- GetModifierAttackSpeedAbsoluteMax
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 275 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 272 -- GetModifierAttackSpeedReductionPercentage
MODIFIER_PROPERTY_ATTACK_ANIM_TIME_PERCENTAGE = 129 -- GetModifierPercentageAttackAnimTime
MODIFIER_PROPERTY_ATTACK_HEIGHT_BONUS = 334 -- GetModifierAttackHeightBonus
MODIFIER_PROPERTY_ATTACK_POINT_CONSTANT = 39 -- GetModifierAttackPointConstant
MODIFIER_PROPERTY_ATTACK_RANGE_BASE_OVERRIDE = 113 -- GetModifierAttackRangeOverride
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 114 -- GetModifierAttackRangeBonus
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_PERCENTAGE = 116 -- GetModifierAttackRangeBonusPercentage
MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 115 -- GetModifierAttackRangeBonusUnique
MODIFIER_PROPERTY_ATTACK_WHILE_MOVING_TARGET = 274
MODIFIER_PROPERTY_AVOID_ATTACK_PROCS = 354 -- GetModifierAvoidAttackProcs
MODIFIER_PROPERTY_AVOID_DAMAGE = 71 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_DAMAGE_AFTER_REDUCTIONS = 287 -- GetModifierAvoidDamageAfterReductions
...
MODIFIER_PROPERTY_BASEATTACK_POSTBONUS = 350 -- GetBaseAttackPostBonus
...
MODIFIER_PROPERTY_BASE_ARMOR_PER_AGI_BONUS_PERCENTAGE = 327 -- GetModifierBonusLotusHeal
...
MODIFIER_PROPERTY_BASE_HP_REGEN_PER_STR_BONUS_PERCENTAGE = 326 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BASE_MANA_REGEN = 88 -- GetModifierBaseRegen
MODIFIER_PROPERTY_BASE_MP_REGEN_PER_INT_BONUS_PERCENTAGE = 328 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BASE_MRES_PER_INT_BONUS_PERCENTAGE = 329 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BECOME_AGILITY = 300 -- GetModifierBecomeAgility
MODIFIER_PROPERTY_BECOME_INTELLIGENCE = 301 -- GetModifierBecomeIntelligence
MODIFIER_PROPERTY_BECOME_STRENGTH = 299 -- GetModifierBecomeStrength
MODIFIER_PROPERTY_BECOME_UNIVERSAL = 302 -- GetModifierBecomeUniversal
MODIFIER_PROPERTY_BONUSDAMAGEOUTGOING_PERCENTAGE = 40 -- GetModifierBonusDamageOutgoing_Percentage
MODIFIER_PROPERTY_BONUS_DAY_VISION = 151 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_DAY_VISION_PERCENTAGE = 152 -- GetBonusDayVisionPercentage
MODIFIER_PROPERTY_BONUS_LOTUS_HEAL = 325 -- GetModifierBonusLotusHeal
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 153 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 154 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_UPHILL_MISS_CHANCE = 320 -- GetModifierBonusUphillMissChance
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 155 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 271 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 176 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 177 -- Unused
MODIFIER_PROPERTY_BUYBACK_PENALTY_PERCENT = 316 -- GetModifierBuybackPenaltyPercent
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 260 -- GetModifierCanAttackTrees
MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 128 -- GetModifierPercentageCasttime
MODIFIER_PROPERTY_CAST_RANGE_BONUS = 109 -- GetModifierCastRangeBonus
MODIFIER_PROPERTY_CAST_RANGE_BONUS_PERCENTAGE = 110 -- GetModifierCastRangeBonusPercentage
MODIFIER_PROPERTY_CAST_RANGE_BONUS_STACKING = 112 -- GetModifierCastRangeBonusStacking
MODIFIER_PROPERTY_CAST_RANGE_BONUS_TARGET = 111 -- GetModifierCastRangeBonusTarget
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 249 -- GetModifierChangeAbilityValue
MODIFIER_PROPERTY_CONVERT_ATTACK_PHYSICAL_TO_PURE = 188 -- GetConvertAttackPhysicalToPure
MODIFIER_PROPERTY_CONVERT_MANA_COST_TO_HEALTH_COST = 245 -- GetModifierConvertManaCostToHealthCost
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 126 -- GetModifierPercentageCooldown
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_ONGOING = 127 -- GetModifierPercentageCooldownOngoing
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 278 -- GetModifierPercentageCooldownStacking
MODIFIER_PROPERTY_COOLDOWN_REDUCTION_CONSTANT = 33 -- GetModifierCooldownReduction_Constant
MODIFIER_PROPERTY_CREATE_BONUS_ILLUSION_CHANCE = 331 -- GetModifierCreateBonusIllusionChance
MODIFIER_PROPERTY_CREATE_BONUS_ILLUSION_COUNT = 332 -- GetModifierCreateBonusIllusionCount
MODIFIER_PROPERTY_CREEP_DENY_PERCENT = 321 -- GetModifierCreepDenyPercent
MODIFIER_PROPERTY_CRITICAL_STRIKE_BONUS = 187 -- GetCriticalStrikeBonus
...
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_MULTIPLICATIVE = 292 -- GetModifierDamageOutgoing_PercentageMultiplicative
MODIFIER_PROPERTY_DEATHGOLDCOST = 134 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 150 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 170 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_MANA_GAIN = 171 -- GetDisableManaGain
MODIFIER_PROPERTY_DISABLE_TURNING = 247 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DISASSEMBLE_ANYTHING = 318 -- GetModifierDisassembleAnything
MODIFIER_PROPERTY_DODGE_PROJECTILE = 179 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 264 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 66 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 136 -- GetModifierPercentageExpRateBoost
...
MODIFIER_PROPERTY_FAIL_ATTACK = 288 -- GetModifierPropetyFailAttack
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 30 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 156 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_MANA_REGEN = 319 -- GetModifierFixedManaRegen
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 157 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 246 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_FORCE_MAX_HEALTH = 308 -- GetModifierForceMaxHealth
MODIFIER_PROPERTY_FORCE_MAX_MANA = 309 -- GetModifierForceMaxMana
MODIFIER_PROPERTY_FOW_TEAM = 323 -- GetModifierFoWTeam
MODIFIER_PROPERTY_GOLD_RATE_BOOST = 137 -- GetModifierPercentageGoldRateBoost
MODIFIER_PROPERTY_HAS_BONUS_NEUTRAL_ITEM_CHOICE = 307 -- GetModifierHasBonusNeutralItemChoice
MODIFIER_PROPERTY_HEALTHBAR_PIPS = 284 -- GetModifierHealthBarPips
MODIFIER_PROPERTY_HEALTHCOST_PERCENTAGE = 132 -- GetModifierPercentageHealthcost
MODIFIER_PROPERTY_HEALTHCOST_PERCENTAGE_STACKING = 133 -- GetModifierPercentageHealthcostStacking
...
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_SOURCE = 49 -- GetModifierHealAmplify_PercentageSource
MODIFIER_PROPERTY_HEAL_AMPLIFY_PERCENTAGE_TARGET = 50 -- GetModifierHealAmplify_PercentageTarget
MODIFIER_PROPERTY_HEROFACET_OVERRIDE = 340 -- GetModifierHeroFacetOverride
MODIFIER_PROPERTY_HP_REGEN_AMPLIFY_PERCENTAGE = 52 -- GetModifierHPRegenAmplify_Percentage
MODIFIER_PROPERTY_HP_REGEN_CAN_BE_NEGATIVE = 51 -- GetModifierHPRegen_CanBeNegative
MODIFIER_PROPERTY_HP_REGEN_MULTIPLIER_PRE_AMPLIFICATION = 339 -- GetModifierHPRegenMultiplierPreAmplification
MODIFIER_PROPERTY_IGNORE_ATTACKSPEED_LIMIT = 32 -- GetModifierAttackSpeed_Limit
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 248 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 259 -- GetModifierIgnoreCooldown
...
MODIFIER_PROPERTY_ILLUSION_LABEL = 163 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT = 285 -- GetModifierIncomingDamageConstant
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST = 291 -- MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 263
...
MODIFIER_PROPERTY_INNATE_DAMAGE_BLOCK_PCT_OVERRIDE = 143 -- GetModifierInnateDamageBlockPctOverride
MODIFIER_PROPERTY_INVENTORY_SLOT_RESTRICTED = 347 -- GetModifierInventorySlotRestricted
...
MODIFIER_PROPERTY_IS_ILLUSION = 162 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 237 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 238 -- GetModifierShard
MODIFIER_PROPERTY_ITEM_SELLBACK_COST = 317 -- GetModifierItemSellbackCost
MODIFIER_PROPERTY_KILL_STREAK_BONUS_GOLD_PERCENTAGE = 338 -- GetModifierKillStreakBonusGoldPercentage
MODIFIER_PROPERTY_KNOCKBACK_AMPLIFICATION_PERCENTAGE = 283 -- GetModifierKnockbackAmplification_Percentage
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 53 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 242 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_ARMOR_PIERCING_PERCENTAGE_TARGET = 186 -- GetMagicalArmorPiercingPercentageTarget
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 140 -- GetModifierMagical_ConstantBlock
...
MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 130 -- GetModifierPercentageManacost
MODIFIER_PROPERTY_MANACOST_PERCENTAGE_STACKING = 131 -- GetModifierPercentageManacostStacking
...
MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 117 -- GetModifierMaxAttackRange
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 181 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_ATTRIBUTE_LEVEL = 343 -- MinAttributeLevel
MODIFIER_PROPERTY_MIN_HEALTH = 158 -- GetMinHealth
...
MODIFIER_PROPERTY_MISS_PERCENTAGE_TARGET = 336 -- GetModifierMiss_Percentage_Target
MODIFIER_PROPERTY_MODEL_CHANGE = 232 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 233 -- GetModifierModelScale
MODIFIER_PROPERTY_MODEL_SCALE_ANIMATE_TIME = 234 -- GetModifierModelScaleAnimateTime
MODIFIER_PROPERTY_MODEL_SCALE_CONSTANT = 236 -- GetModifierModelScaleConstant
MODIFIER_PROPERTY_MODEL_SCALE_USE_IN_OUT_EASE = 235 -- GetModifierModelScaleUseInOutEase
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 273 -- GetModifierMoveSpeedReductionPercentage
...
MODIFIER_PROPERTY_NO_FREE_TP_SCROLL_ON_DEATH = 306 -- GetModifierNoFreeTPScrollOnDeath
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 250 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 251 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 146 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 147 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 11 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 174 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PACK_RAT = 281 -- GetModifierIsPackRat
MODIFIER_PROPERTY_PERCENTAGE_DEATHGOLDCOST = 135 -- GetModifierPercentageDeathGoldCost
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 15 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICALDAMAGEOUTGOING_PERCENTAGE = 282 -- GetModifierPhysicalDamageOutgoing_Percentage
...
MODIFIER_PROPERTY_PHYSICAL_ARMOR_PIERCING_PERCENTAGE_TARGET = 185 -- GetPhysicalArmorPiercingPercentageTarget
MODIFIER_PROPERTY_PHYSICAL_ARMOR_TOTAL_PERCENTAGE = 75 -- GetModifierPhysicalArmorTotal_Percentage
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 141 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 142 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 138 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 183 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 139 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PREREDUCE_INCOMING_DAMAGE_MULT = 289 -- GetModifierPrereduceIncomingDamage_Mult
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 257 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 12 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 182 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_NAME = 120 -- GetModifierProjectileName
MODIFIER_PROPERTY_PROJECTILE_SPEED = 297 -- GetModifierProjectileSpeed
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 118 -- GetModifierProjectileSpeedBonus
MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS_PERCENTAGE = 119 -- GetModifierProjectileSpeedBonusPercentage
MODIFIER_PROPERTY_PROJECTILE_SPEED_TARGET = 298 -- GetModifierProjectileSpeedTarget
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 243 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_PSEUDORANDOM_BONUS = 333 -- GetModofierPropertyPseudoRandomBonus
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 239 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_REDIRECT_SPELL = 349 -- GetRedirectSpell
MODIFIER_PROPERTY_REFLECT_SPELL = 149 -- GetReflectSpell
MODIFIER_PROPERTY_REINCARNATION = 121 -- ReincarnateTime
MODIFIER_PROPERTY_REINCARNATION_SUPPRESS_FX = 122 -- ReincarnateSuppressFX
MODIFIER_PROPERTY_RESPAWNTIME = 123 -- GetModifierConstantRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 124 -- GetModifierPercentageRespawnTime
MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 125 -- GetModifierStackingRespawnTime
MODIFIER_PROPERTY_SHARE_XPRUNE = 305 -- GetModifierShareXPRune
MODIFIER_PROPERTY_SKIP_ATTACK_REGULATOR = 335 -- GetSkipAttackRegulator
MODIFIER_PROPERTY_SLOW_RESISTANCE_STACKING = 295 -- GetModifierSlowResistance_Stacking
MODIFIER_PROPERTY_SLOW_RESISTANCE_UNIQUE = 294 -- GEtModifierSlowResistance_Unique
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 244 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_SPELL_AMPLIFY_PERCENTAGE_TARGET = 48 -- GetModifierSpellAmplify_PercentageTarget
...
MODIFIER_PROPERTY_SPELL_REDIRECT_TARGET = 279 -- GetModifierSpellRedirectTarget
...
MODIFIER_PROPERTY_STRONG_ILLUSION = 164 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 165 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 166 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_ATTACK_PROCS = 352 -- GetSuppressAttackProcs
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 270 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_CRIT = 314 -- GetSuppressCrit
MODIFIER_PROPERTY_SUPPRESS_FULLSCREEN_DEATH_FX = 290 -- GetModifierSuppressFullscreenDeathFX
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 268 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 256 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TICK_GOLD_MULTIPLIER = 293 -- GetModifierTickGold_Multiplier
MODIFIER_PROPERTY_TIER_TOKEN_REROLL = 344 -- GetTierTokenReroll
MODIFIER_PROPERTY_TOOLTIP = 231 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 265 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 44 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 145 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_STACKING = 346 -- GetModifierTotal_ConstantBlockStacking
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 144 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 240 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 241 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 180 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_CONSTANT = 280 -- GetModifierTurnRateConstant
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 169 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 168 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 178 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 175 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISION_DEGREES_RESTRICTION = 345 -- GetVisionDegreeRestriction
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 261 -- GetVisualZDelta
MODIFIER_PROPERTY_VISUAL_Z_SPEED_BASE_OVERRIDE = 262 -- GetVisualZSpeedBaseOverride
MODIFIER_PROPERTY_XP_DURING_DEATH = 167 -- GetModifierXPDuringDeath
...
-- @param hAbility handle
-- @param hBuff handle
function CDOTA_BaseNPC:TriggerModifierDodge( hAbility, hBuff ) end
...
-- @return void
-- @param flDelayRemove float
function CDOTA_Item:SpendCharge( flDelayRemove ) end
