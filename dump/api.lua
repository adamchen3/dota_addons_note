...
MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 193 -- OnAbilityEndChannel
MODIFIER_EVENT_ON_ABILITY_EXECUTED = 190 -- OnAbilityExecuted
MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 191 -- OnAbilityFullyCast
MODIFIER_EVENT_ON_ABILITY_START = 189 -- OnAbilityStart
MODIFIER_EVENT_ON_ASSIST = 243 -- OnAssist
MODIFIER_EVENT_ON_ATTACK = 182 -- OnAttack
MODIFIER_EVENT_ON_ATTACKED = 203 -- OnAttacked
MODIFIER_EVENT_ON_ATTACK_ALLIED = 185 -- OnAttackAllied
MODIFIER_EVENT_ON_ATTACK_CANCELLED = 257 -- OnAttackCancelled
MODIFIER_EVENT_ON_ATTACK_FAIL = 184 -- OnAttackFail
MODIFIER_EVENT_ON_ATTACK_FINISHED = 246 -- OnAttackFinished
MODIFIER_EVENT_ON_ATTACK_LANDED = 183 -- OnAttackLanded
MODIFIER_EVENT_ON_ATTACK_RECORD = 180 -- OnAttackRecord
MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY = 254 -- OnAttackRecordDestroy
MODIFIER_EVENT_ON_ATTACK_START = 181 -- OnAttackStart
MODIFIER_EVENT_ON_ATTEMPT_PROJECTILE_DODGE = 264 -- OnAttemptProjectileDodge
MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 192 -- OnBreakInvisibility
MODIFIER_EVENT_ON_BUILDING_KILLED = 217 -- OnBuildingKilled
MODIFIER_EVENT_ON_DAMAGE_CALCULATED = 201 -- OnDamageCalculated
MODIFIER_EVENT_ON_DAMAGE_HPLOSS = 287 -- OnDamageHPLoss
MODIFIER_EVENT_ON_DEATH = 204 -- OnDeath
MODIFIER_EVENT_ON_DEATH_COMPLETED = 205 -- OnDeathCompleted
MODIFIER_EVENT_ON_DEATH_PREVENTED = 197 -- OnDamagePrevented
MODIFIER_EVENT_ON_DOMINATED = 241 -- OnDominated
MODIFIER_EVENT_ON_FORCE_PROC_MAGIC_STICK = 286 -- OnForceProcMagicStick
MODIFIER_EVENT_ON_HEALTH_GAINED = 212 -- OnHealthGained
MODIFIER_EVENT_ON_HEAL_RECEIVED = 216 -- OnHealReceived
MODIFIER_EVENT_ON_HERO_KILLED = 215 -- OnHeroKilled
MODIFIER_EVENT_ON_KILL = 242 -- OnKill
MODIFIER_EVENT_ON_MAGIC_DAMAGE_CALCULATED = 202 -- OnMagicDamageCalculated
MODIFIER_EVENT_ON_MANA_GAINED = 213 -- OnManaGained
MODIFIER_EVENT_ON_MODEL_CHANGED = 218 -- OnModelChanged
MODIFIER_EVENT_ON_MODIFIER_ADDED = 219 -- OnModifierAdded
MODIFIER_EVENT_ON_MUTE_DAMAGE_ABILITIES = 291 -- OnMuteDamageAbilities
MODIFIER_EVENT_ON_ORB_EFFECT = 199 -- Unused
MODIFIER_EVENT_ON_ORDER = 187 -- OnOrder
MODIFIER_EVENT_ON_PREDEBUFF_APPLIED = 265 -- OnPreDebuffApplied
MODIFIER_EVENT_ON_PROCESS_CLEAVE = 200 -- OnProcessCleave
MODIFIER_EVENT_ON_PROCESS_UPGRADE = 194 -- Unused
MODIFIER_EVENT_ON_PROJECTILE_DODGE = 186 -- OnProjectileDodge
MODIFIER_EVENT_ON_PROJECTILE_OBSTRUCTION_HIT = 255 -- OnProjectileObstructionHit
MODIFIER_EVENT_ON_REFRESH = 195 -- Unused
MODIFIER_EVENT_ON_RESPAWN = 206 -- OnRespawn
MODIFIER_EVENT_ON_SET_LOCATION = 211 -- OnSetLocation
MODIFIER_EVENT_ON_SPELL_TARGET_READY = 179 -- OnSpellTargetReady
MODIFIER_EVENT_ON_SPENT_HEALTH = 208 -- OnSpentHealth
MODIFIER_EVENT_ON_SPENT_MANA = 207 -- OnSpentMana
MODIFIER_EVENT_ON_STATE_CHANGED = 198 -- OnStateChanged
MODIFIER_EVENT_ON_TAKEDAMAGE = 196 -- OnTakeDamage
MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 214 -- OnTakeDamageKillCredit
MODIFIER_EVENT_ON_TAKEDAMAGE_POST_UNAVOIDABLE_BLOCK = 290 -- OnTakeDamagePostUnavoidableBlock
MODIFIER_EVENT_ON_TELEPORTED = 210 -- OnTeleported
MODIFIER_EVENT_ON_TELEPORTING = 209 -- OnTeleporting
MODIFIER_EVENT_ON_UNIT_MOVED = 188 -- OnUnitMoved
MODIFIER_EVENT_SPELL_APPLIED_SUCCESSFULLY = 274 -- OnSpellAppliedSuccessfully
MODIFIER_FUNCTION_INVALID = 65535
MODIFIER_FUNCTION_LAST = 293
MODIFIER_PROPERTY_ABILITY_LAYOUT = 240 -- GetModifierAbilityLayout
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 155 -- GetAbsoluteNoDamageMagical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 154 -- GetAbsoluteNoDamagePhysical
MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 156 -- GetAbsoluteNoDamagePure
MODIFIER_PROPERTY_ABSORB_SPELL = 143 -- GetAbsorbSpell
MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK = 166 -- GetAlwaysAllowAttack
MODIFIER_PROPERTY_ALWAYS_AUTOATTACK_WHILE_HOLD_POSITION = 178 -- GetAlwaysAutoAttackWhileHoldPosition
MODIFIER_PROPERTY_ALWAYS_ETHEREAL_ATTACK = 167 -- GetAllowEtherealAttack
MODIFIER_PROPERTY_AOE_BONUS_CONSTANT = 289 -- GetModifierAoEBonusConstant
MODIFIER_PROPERTY_AOE_BONUS_PERCENTAGE = 283 -- GetModifierAoEBonusPercentage
...
MODIFIER_PROPERTY_ATTACKSPEED_PERCENTAGE = 263 -- GetModifierAttackSpeedPercentage
MODIFIER_PROPERTY_ATTACKSPEED_REDUCTION_PERCENTAGE = 260 -- GetModifierAttackSpeedReductionPercentage
...
MODIFIER_PROPERTY_ATTACK_WHILE_MOVING_TARGET = 262
MODIFIER_PROPERTY_AVOID_DAMAGE = 68 -- GetModifierAvoidDamage
MODIFIER_PROPERTY_AVOID_DAMAGE_AFTER_REDUCTIONS = 275 -- GetModifierAvoidDamageAfterReductions
...
MODIFIER_PROPERTY_BECOME_UNIVERSAL = 285 -- GetModifierBecomeUniversal
MODIFIER_PROPERTY_BONUSDAMAGEOUTGOING_PERCENTAGE = 40 -- GetModifierBonusDamageOutgoing_Percentage
MODIFIER_PROPERTY_BONUS_DAY_VISION = 146 -- GetBonusDayVision
MODIFIER_PROPERTY_BONUS_DAY_VISION_PERCENTAGE = 147 -- GetBonusDayVisionPercentage
MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 148 -- GetBonusNightVision
MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 149 -- GetBonusNightVisionUnique
MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 150 -- GetBonusVisionPercentage
MODIFIER_PROPERTY_BOT_ATTACK_SCORE_BONUS = 259 -- BotAttackScoreBonus
MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 170 -- Unused
MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 171 -- Unused
MODIFIER_PROPERTY_CAN_ATTACK_TREES = 248 -- GetModifierCanAttackTrees
...
MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 237 -- GetModifierChangeAbilityValue
...
MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 266 -- GetModifierPercentageCooldownStacking
...
MODIFIER_PROPERTY_DAMAGEOUTGOING_PERCENTAGE_MULTIPLICATIVE = 280 -- GetModifierDamageOutgoing_PercentageMultiplicative
MODIFIER_PROPERTY_DEATHGOLDCOST = 131 -- GetModifierConstantDeathGoldCost
MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 145 -- GetDisableAutoAttack
MODIFIER_PROPERTY_DISABLE_HEALING = 165 -- GetDisableHealing
MODIFIER_PROPERTY_DISABLE_TURNING = 235 -- GetModifierDisableTurning
MODIFIER_PROPERTY_DODGE_PROJECTILE = 173 -- GetModifierDodgeProjectile
MODIFIER_PROPERTY_DONT_GIVE_VISION_OF_ATTACKER = 252 -- GetModifierNoVisionOfAttacker
MODIFIER_PROPERTY_EVASION_CONSTANT = 63 -- GetModifierEvasion_Constant
MODIFIER_PROPERTY_EXP_RATE_BOOST = 132 -- GetModifierPercentageExpRateBoost
...
MODIFIER_PROPERTY_FAIL_ATTACK = 276 -- GetModifierPropetyFailAttack
MODIFIER_PROPERTY_FIXED_ATTACK_RATE = 30 -- GetModifierFixedAttackRate
MODIFIER_PROPERTY_FIXED_DAY_VISION = 151 -- GetFixedDayVision
MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 152 -- GetFixedNightVision
MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 234 -- GetForceDrawOnMinimap
MODIFIER_PROPERTY_FORCE_MAX_HEALTH = 288 -- GetModifierForceMaxHealth
MODIFIER_PROPERTY_GOLD_RATE_BOOST = 133 -- GetModifierPercentageGoldRateBoost
MODIFIER_PROPERTY_HEALTHBAR_PIPS = 272 -- GetModifierHealthBarPips
...
MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 236 -- GetModifierIgnoreCastAngle
MODIFIER_PROPERTY_IGNORE_COOLDOWN = 247 -- GetModifierIgnoreCooldown
...
MODIFIER_PROPERTY_ILLUSION_LABEL = 158 -- GetModifierIllusionLabel
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT = 273 -- GetModifierIncomingDamageConstant
MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST = 279 -- MODIFIER_PROPERTY_INCOMING_DAMAGE_CONSTANT_POST
MODIFIER_PROPERTY_INCOMING_DAMAGE_ILLUSION = 251
...
MODIFIER_PROPERTY_IS_ILLUSION = 157 -- GetIsIllusion
MODIFIER_PROPERTY_IS_SCEPTER = 226 -- GetModifierScepter
MODIFIER_PROPERTY_IS_SHARD = 227 -- GetModifierShard
MODIFIER_PROPERTY_KNOCKBACK_AMPLIFICATION_PERCENTAGE = 271 -- GetModifierKnockbackAmplification_Percentage
MODIFIER_PROPERTY_LIFESTEAL_AMPLIFY_PERCENTAGE = 52 -- GetModifierLifestealRegenAmplify_Percentage
MODIFIER_PROPERTY_LIFETIME_FRACTION = 231 -- GetUnitLifetimeFraction
MODIFIER_PROPERTY_MAGICAL_CONSTANT_BLOCK = 136 -- GetModifierMagical_ConstantBlock
...
MODIFIER_PROPERTY_MAX_DEBUFF_DURATION = 175 -- GetModifierMaxDebuffDuration
MODIFIER_PROPERTY_MIN_HEALTH = 153 -- GetMinHealth
...
MODIFIER_PROPERTY_MODEL_CHANGE = 221 -- GetModifierModelChange
MODIFIER_PROPERTY_MODEL_SCALE = 222 -- GetModifierModelScale
MODIFIER_PROPERTY_MODEL_SCALE_ANIMATE_TIME = 223 -- GetModifierModelScaleAnimateTime
MODIFIER_PROPERTY_MODEL_SCALE_CONSTANT = 225 -- GetModifierModelScaleConstant
MODIFIER_PROPERTY_MODEL_SCALE_USE_IN_OUT_EASE = 224 -- GetModifierModelScaleUseInOutEase
...
MODIFIER_PROPERTY_MOVESPEED_REDUCTION_PERCENTAGE = 261 -- GetModifierMoveSpeedReductionPercentage
...
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL = 238 -- GetModifierOverrideAbilitySpecial
MODIFIER_PROPERTY_OVERRIDE_ABILITY_SPECIAL_VALUE = 239 -- GetModifierOverrideAbilitySpecialValue
MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 141 -- GetOverrideAnimation
MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 142 -- GetOverrideAnimationRate
MODIFIER_PROPERTY_OVERRIDE_ATTACK_DAMAGE = 11 -- GetModifierOverrideAttackDamage
MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 168 -- GetOverrideAttackMagical
MODIFIER_PROPERTY_PERSISTENT_INVISIBILITY = 15 -- GetModifierPersistentInvisibility
MODIFIER_PROPERTY_PHYSICALDAMAGEOUTGOING_PERCENTAGE = 270 -- GetModifierPhysicalDamageOutgoing_Percentage
...
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 137 -- GetModifierPhysical_ConstantBlock
MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK_SPECIAL = 138 -- GetModifierPhysical_ConstantBlockSpecial
...
MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 134 -- GetModifierPreAttack_CriticalStrike
MODIFIER_PROPERTY_PREATTACK_DEADLY_BLOW = 177 -- GetModifierPreAttack_DeadlyBlow
MODIFIER_PROPERTY_PREATTACK_TARGET_CRITICALSTRIKE = 135 -- GetModifierPreAttack_Target_CriticalStrike
MODIFIER_PROPERTY_PREREDUCE_INCOMING_DAMAGE_MULT = 277 -- GetModifierPrereduceIncomingDamage_Mult
MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 245 -- PreserveParticlesOnModelChanged
MODIFIER_PROPERTY_PRE_ATTACK = 12 -- GetModifierPreAttack
MODIFIER_PROPERTY_PRIMARY_STAT_DAMAGE_MULTIPLIER = 176 -- GetPrimaryStatDamageMultiplier
...
MODIFIER_PROPERTY_PROJECTILE_SPEED = 284 -- GetModifierProjectileSpeed
...
MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 232 -- GetModifierProvidesFOWVision
MODIFIER_PROPERTY_RADAR_COOLDOWN_REDUCTION = 228 -- GetModifierRadarCooldownReduction
MODIFIER_PROPERTY_RAT_PACK = 269 -- GetModifierIsRatPack
MODIFIER_PROPERTY_REFLECT_SPELL = 144 -- GetReflectSpell
...
MODIFIER_PROPERTY_SLOW_RESISTANCE = 282 -- GetModifierSlowResistance
MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 233 -- GetModifierSpellsRequireHP
...
MODIFIER_PROPERTY_SPELL_REDIRECT_TARGET = 267 -- GetModifierSpellRedirectTarget
...
MODIFIER_PROPERTY_STRONG_ILLUSION = 159 -- GetModifierStrongIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION = 160 -- GetModifierSuperIllusion
MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 161 -- GetModifierSuperIllusionWithUltimate
MODIFIER_PROPERTY_SUPPRESS_CLEAVE = 258 -- GetSuppressCleave
MODIFIER_PROPERTY_SUPPRESS_CRIT = 292 -- GetSuppressCrit
MODIFIER_PROPERTY_SUPPRESS_FULLSCREEN_DEATH_FX = 278 -- GetModifierSuppressFullscreenDeathFX
MODIFIER_PROPERTY_SUPPRESS_TELEPORT = 256 -- GetSuppressTeleport
MODIFIER_PROPERTY_TEMPEST_DOUBLE = 244 -- GetModifierTempestDouble
MODIFIER_PROPERTY_TICK_GOLD_MULTIPLIER = 281 -- GetModifierTickGold_Multiplier
MODIFIER_PROPERTY_TOOLTIP = 220 -- OnTooltip
MODIFIER_PROPERTY_TOOLTIP2 = 253 -- OnTooltip2
MODIFIER_PROPERTY_TOTALDAMAGEOUTGOING_PERCENTAGE = 44 -- GetModifierTotalDamageOutgoing_Percentage
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 140 -- GetModifierTotal_ConstantBlock
MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 139 -- GetModifierPhysical_ConstantBlockUnavoidablePreArmor
MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 229 -- GetActivityTranslationModifiers
MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 230 -- GetAttackSound
MODIFIER_PROPERTY_TRIGGER_COSMETIC_AND_END_ATTACK = 174 -- GetTriggerCosmeticAndEndAttack
MODIFIER_PROPERTY_TURN_RATE_CONSTANT = 268 -- GetModifierTurnRateConstant
MODIFIER_PROPERTY_TURN_RATE_OVERRIDE = 164 -- GetModifierTurnRate_Override
MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 163 -- GetModifierTurnRate_Percentage
MODIFIER_PROPERTY_UNIT_DISALLOW_UPGRADING = 172 -- GetModifierUnitDisllowUpgrading
MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 169 -- GetModifierUnitStatsNeedsRefresh
MODIFIER_PROPERTY_VISUAL_Z_DELTA = 249 -- GetVisualZDelta
MODIFIER_PROPERTY_VISUAL_Z_SPEED_BASE_OVERRIDE = 250 -- GetVisualZSpeedBaseOverride
MODIFIER_PROPERTY_XP_DURING_DEATH = 162 -- GetModifierXPDuringDeath
